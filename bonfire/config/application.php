...
|
*/
$config['OCU_site_name'] = "Unamed Ocular-Powered Website";
...
|
*/
$config['OCU_layout_folder'] = "_layouts/";
...
$config['assets_css']	= array('style', 'handheld');
...
$config['cache_container']			= 'File';
$config['cache_container_options']	= array();
